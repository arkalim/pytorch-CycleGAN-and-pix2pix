...
class TUMDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        true_A = transformed_['mr'].data[:, :self.input_size[0], :self.input_size[1], :self.input_size[2]]
        true_B = transformed_['trus'].data[:, :self.input_size[0], :self.input_size[1], :self.input_size[2]]
        ...
        dict_['S'] = torch.where(mask > 0, ones, minus_ones)[:, 23, :, :]
        return dict_
